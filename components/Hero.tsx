...
const Hero: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center pt-24 pb-12 relative px-4 sm:px-6 overflow-hidden">
      {/* Background Glow */}
      <div 
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-5xl aspect-square bg-gradient-to-br from-indigo-500/10 to-purple-500/5 blur-[160px] rounded-full -z-10 pointer-events-none"
      ...
      <div className="text-center w-full max-w-6xl mx-auto relative z-10">
        <div className="mb-8 reveal">
          <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-indigo-500/20 text-indigo-400 glass">
            ...
            <span className="text-[10px] font-bold tracking-[0.2em] uppercase tabular-nums">
              {formatTime(time)} • AVAILABLE FOR HIRE
            </span>
          </div>
        </div>
        
        <h1 className="syncopate text-4xl sm:text-5xl md:text-7xl lg:text-9xl font-bold tracking-tighter leading-[1.1] mb-10 break-words reveal">
        ...
        <p className="max-w-2xl mx-auto text-base md:text-xl text-zinc-400 mb-12 px-4 reveal">
          Elite 2D animation, cinematic illustration, and high-impact visual design. We turn abstract concepts into digital reality.
        </p>

        <div className="flex flex-col sm:flex-row gap-5 justify-center items-center px-6 reveal">
          <button 
            onClick={() => scrollTo('work')}
            className="w-full sm:w-auto group relative px-10 py-5 bg-indigo-600 rounded-full font-bold transition-all flex items-center justify-center gap-2 overflow-hidden shadow-2xl shadow-indigo-500/20"
          >
          ...
          <button 
            ...
            className="w-full sm:w-auto px-10 py-5 glass border border-zinc-800 rounded-full font-bold transition-all flex items-center justify-center gap-2 hover:border-zinc-500 hover:bg-zinc-800/50"
          >
